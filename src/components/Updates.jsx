            ...
            <div className='flex flex-col gap-5 max-lg:mt-64'>
                ...
                >
                    ...
                    <div className='flex justify-between max-w-lg space-x-5 py-5'>
                        ...
                        <h1 className='font-robert-medium text-xl max-w-xs'>Welcome NEXUS: Webdrave’s Social Gateway</h1>
                    </div>
                </div>
                ...
                >
                    ...
                    <div className='flex justify-between space-x-5 max-w-lg py-5'>
                        ...
                        <h1 className='font-robert-medium text-xl max-w-xs'>Introducing Webdrave: The Metagame Layer</h1>
                    </div>
                </div>
            </div>
        </section>
